...
```{r}
setwd("/Users/tarineccleston/Documents/Masters/STATS 765/statistical-learning-for-DS")
library(ranger)
library(tidyverse)
...
If the model is not using equal weight, it will create bias in the higher weighted classes, therefore we would expect to have more features prominent in 
